...
export const HistoryView: React.FC<HistoryViewProps> = ({
  ...
  const getTraceSummary = (item: HistoryItem): string => {
    ...
    return `Deterministic heuristic traversal originating from ${shortAddr} resolved across ${item.hopsCount} transactional hops on ${item.chain}. Capital routed through verified liquidity pools and intermediary peel nodes before terminal attribution into ${item.targetExchange} with ${item.confidence}/100 score.`;
  };
      ...
      <div className="flex flex-col sm:flex-row items-center gap-3">
        ...
        <div className="flex items-center gap-1.5 w-full sm:w-auto">
          ...
          >
            ...
            <option value="clean">No mixer flag (not assessed)</option>
          </select>
        </div>
      </div>
                  ...
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <div className="text-[11px] font-mono text-[#c2c6d7] flex items-center gap-1.5">
                        <span className="text-[#10b981] font-semibold">{item.confidence}/100 score</span>
                        <span>•</span>
